...
import 'package:module_5/custom_widgets/search.dart';
...
import 'package:module_5/pages/user_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      AppBar(
        backgroundColor: primeColor,
        automaticallyImplyLeading: false,
        title: Text('Home Page',style: CustomStyle.AppStyle(color: Colors.white,fontsizs: 18)),
        actions: [
          IconButton(onPressed: (){
            isView = true;
            setState(() {
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Text(priority,style: CustomStyle.AppStyle(color: priorityColor,fontsizs: 12,fontWeight: FontWeight.w500),),
          ),
          SizedBox(width: 15,),
          Expanded(
            child: Column(
              ...
              children: [
                Text(userName,style: CustomStyle.AppStyle(color: primeColor,fontsizs: 18),),
                Text('Date : $date',textAlign: TextAlign.right,style: CustomStyle.AppStyle(color: greyColor,fontsizs: 12),),
                Text('Time :$time',textAlign: TextAlign.right,style: CustomStyle.AppStyle(color: greyColor,fontsizs: 12),),
                SizedBox(height: 2,),
                Text(description,maxLines: 1,textAlign: TextAlign.left,style: CustomStyle.AppStyle(color: greyColor,fontsizs: 12),),
              ],
            ),
          ),
          Center(
