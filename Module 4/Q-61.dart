...
class _searchToolbarPageState extends State<searchToolbarPage> {
  ...
  List<String> cityNameList = ['Pune','Bangloar','Mumbai','Ahemdabad','Surat','baroda','Rajkot','Junagadh','Porbandar',];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Search City",style: TextStyle(color: Colors.white,fontSize: 16),),
        actions: [
