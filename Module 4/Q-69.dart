        ...
        child: ListView
          ...
          [
            ...
            ListTile
              ...
              onTap: ()
              {
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>_starredpage()));
              }
            ),
            ListTile
              (
              ...
              title: Text("Snoozed"),
                onTap: ()
                {
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>_snoozedpage()));
                }
            ),
            ListTile
              (
              ...
              title: Text("Sent"),
                onTap: ()
                {
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>_sentpage()));
                }
            ),
            ListTile
              (
              ...
              title: Text("Scheduled"),
                onTap: ()
                {
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>_scheduledpage()));
                }
            ),
            ListTile
              (
              ...
              title: Text("Outbox"),
                onTap: ()
                {
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>_outboxpage()));
                }
            ),
            ListTile
              (
              ...
              title: Text("Drafts"),
                onTap: ()
                {
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>_draftspage()));
                }
            ),
            ListTile
              (
              ...
              title: Text("All mail"),
                onTap: ()
                {
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>_mailpage()));
                }
            ),
            ListTile
              (
              ...
              title: Text("Spam"),
                onTap: ()
                {
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>_spampage()));
                }
            ),
            ListTile
              (
              ...
              title: Text("Delete"),
                onTap: ()
                {
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>_deletepage()));
                }
            ),
          ],
        ),
